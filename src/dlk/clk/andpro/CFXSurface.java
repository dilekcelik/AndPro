...
public class CFXSurface extends Activity implements OnTouchListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		test = BitmapFactory.decodeResource(getResources(), R.drawable.yellowsquare);
...
//Deleted DilekCelikSurface class and pasted everything here
